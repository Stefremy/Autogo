...
export const SEO_KEYWORDS: Record<string, SEOSet> = {
  ...
  legalizar_carro_importado: {
    ...
    description:
      "Serviço completo de legalização de carros importados em Portugal: DAV, inspeção Modelo 112, CoC, ISV e matrícula. Prazo legal, custos e prazos explicados. AutoGo Guimarães.",
    keywords: [
      "legalizar carro importado",
    ...
    faq: [
      "Tenho prazo para legalizar o carro importado?",
      "O que acontece se não legalizar o carro a tempo?",
      "Posso conduzir o carro antes de ter matrícula portuguesa?",
      "O que é a DAV e onde se faz?",
      "Preciso do CoC obrigatoriamente?",
