  ...
  return (
    <>
      ...
      >
        ...
        <div className="lg:hidden flex items-center gap-1 sm:gap-2" style={{ display: 'flex' }}>
          ...
          >
            <div className="w-5 h-5 sm:w-6 sm:h-6 flex flex-col justify-center items-center">
              <span className={`block w-4 sm:w-5 h-0.5 bg-[#22272a] transition-all duration-300 ${mobileMenuOpen ? 'rotate-45 translate-y-1' : '-translate-y-1'}`}></span>
              <span className={`block w-4 sm:w-5 h-0.5 bg-[#22272a] transition-all duration-300 ${mobileMenuOpen ? 'opacity-0' : 'opacity-100'}`}></span>
              <span className={`block w-4 sm:w-5 h-0.5 bg-[#22272a] transition-all duration-300 ${mobileMenuOpen ? '-rotate-45 -translate-y-1' : 'translate-y-1'}`}></span>
            </div>
          </button>
        </div>
      ...
      {mobileMenuOpen && (
        ...
        >
          <div className={`bg-white shadow-xl border-b border-gray-200 ${isLandscape ? 'max-h-72' : ''}`} onClick={(e) => e.stopPropagation()}>
