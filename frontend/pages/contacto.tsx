...
`}} />
      <div className="min-h-screen w-full bg-gradient-to-br from-[#f5f6fa] via-[#fbe9e9] to-[#f5f6fa] flex flex-col overflow-x-hidden relative">
        <img src="/images/audi-scotland.jpg" alt="Fundo" className="pointer-events-none select-none fixed inset-0 w-screen h-screen object-cover opacity-60 z-0 transition-all duration-700" style={{objectPosition: 'center top', filter: 'blur(0.5px)'}} />
        ...
        <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem' }} className="relative z-10">

          <hr />
          <section className="max-w-3xl mx-auto bg-white/95 rounded-2xl shadow-2xl border border-[#b42121]/10 p-8 my-10">
            <h2 className="text-2xl font-bold mb-6 text-[#b42121]">{t('Contacte-nos')}</h2>
            <div className="flex flex-col md:flex-row gap-8">
              {/* Contact Info + Google Maps */}
              <div className="flex-1 space-y-4">
                <div className="flex items-center">
                  <span className="mr-2 text-[#b42121] text-xl" aria-label="Email">@</span>
                  <a href="mailto:AutoGO.stand@gmail.com" className="hover:underline">
                    AutoGO.stand@gmail.com
                  </a>
                </div>
                <div className="flex items-center">
                  <span className="mr-2 text-[#b42121] text-xl" aria-label="Telefone">📱</span>
                ...
                <div className="flex items-center">
                  <span className="mr-2 text-[#b42121]" aria-label="Morada">
                    <svg width="20" height="20" fill="currentColor" viewBox="0 0 20 20"><path d="M10 2a6 6 0 016 6c0 4.418-6 10-6 10S4 12.418 4 8a6 6 0 016-6zm0 8a2 2 0 100-4 2 2 0 000 4z"></path></svg>
                  </span>
                  <a
                ...
                <a
                  ...
                  aria-label="WhatsApp"
                >
                  <img src="/images/whatsapp-logo.png" alt="WhatsApp" className="w-6 h-6" style={{display:'inline'}} />
                  WhatsApp
                </a>
                <iframe
