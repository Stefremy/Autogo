...
const nextConfig = {
  ...
  // Boas práticas gerais (seguros em Next 12+)
  reactStrictMode: true,
  poweredByHeader: false,
  compress: true,

  // Compatível com Next 12+: use 'domains' (evita erro do 'remotePatterns')
  images: {
    domains: [
      "autogo.pt",
      "www.autogo.pt",
      // adicione aqui se usar CDN:
      // "res.cloudinary.com",
      // "images.ctfassets.net",
    ],
  },

  // Headers simples e compatíveis
  async headers() {
    return [
      {
        // padrão: indexável + cache leve
        source: "/:path*",
        headers: [
      ...
      {
        // APIs e áreas internas: não indexar
        source: "/api/:path*",
        headers: [{ key: "X-Robots-Tag", value: "noindex, nofollow" }],
      },
      {
        // assets do Next: cache agressivo seguro
